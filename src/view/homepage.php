          ...
          <div class='row'>
            <div class='nav-col nav-contact col-12 col-md-7 bg-black d-flex align-items-center justify-content-center position-relative py-5 px-3 order-1 order-md-0'>
              ...
              <div class='content position-relative'>
                <h2 class='nav-title white mb-5'>
                  Build your resell empire with us<span class="d-inline green">&period;</span>
                </h2>
                <ul class='contact-items white list-unstyled mb-5'>
                  <li class='pb-4'>
                    <a class='text-decoration-none' href='https://t.me/a1rpodsreps' target="_blank">A1rpodsreps Telegram Channel</a>
                  </li>
                  <li class='pb-4'>
                    <a class='text-decoration-none' href='mailto:moneyluvin@seznam.cz' target="_blank">moneyluvin@seznam.cz</a>
                  </li>
                  <li>
                    <a class='text-decoration-none' href='https://www.google.com/maps/place/Prague' target="_blank">Based in Prague</a>
                  </li>
                </ul>
                <div class='social'>
                  <a class='text-decoration-none green' href='#' target="_blank">instagram</a>
                  <span class='mx-2 white'>
                    |
                  </span>
                  <a class='text-decoration-none green' href='https://t.me/a1rpodsreps' target="_blank">telegram (channel)</a>
                  <span class='mx-2 white'>
                    |
                  </span>
                  <a class='text-decoration-none green' href='https://t.me/Money_Luvin' target="_blank">telegram (personal)</a>
                </div>
              </div>
            </div>
            <div class='nav-col nav-menu col-12 col-md-5 bg-green d-flex align-items-center pt-5 pb-3 pb-md-5 px-3 px-md-5 order-0 order-md-1'>
              <ul class='nav-items list-unstyled'>
                <li class='pb-3'>
                  <a class='text-decoration-none' href='#'>Homepage</a>
                </li>
                <li class='pb-3'>
                  <a class='text-decoration-none' href='#'>Airpods</a>
                </li>
                <li class='pb-3'>
                  <a class='text-decoration-none' href='#'>Vendors</a>
                </li>
                <li>
                  <a class='text-decoration-none' href='#'>Invoices</a>
                </li>
              </ul>
            </div>
          </div>
    ...
    <section class='hero d-flex align-items-center justify-content-center'>
      <div class='video-wrap'>
        <video autoplay="" playsinline="" loop="" muted="" id="video-bg">
          <source src="assets/airpods.mp4" type="video/mp4">
        </video>
      </div>
